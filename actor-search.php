                ...
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="card-body row">
                            ...
                            $query2 = "SELECT m.movie_id, m.title, m.poster_path, m.vote_average, m.tagline FROM movies m INNER JOIN credits c USING (movie_id) WHERE JSON_EXTRACT(cast, '$[*].name') LIKE '%$actor_name%'";
